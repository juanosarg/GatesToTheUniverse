...
{
    public class GenStep_TerrainFarcasterSigmaAlcyon : GenStep
    {
        ...
        private static void RecordAdded(ThingDef plantDef)
        {
            ...
            (dictionary = GenStep_TerrainFarcasterSigmaAlcyon.numExtant)[plantDef] = dictionary[plantDef] + 1;
        }
        ...
        public TerrainDef TerrainFrom(IntVec3 c, Map map, float elevation, float fertility, bool preferSolid)
        {
           ...
           /* if (elevation > 0.55f && elevation < 0.61f)
            ...
            if (!GenStep_TerrainFarcasterSigmaAlcyon.debug_WarnedMissingTerrain)
            {
                ...
                GenStep_TerrainFarcasterSigmaAlcyon.debug_WarnedMissingTerrain = true;
            }
